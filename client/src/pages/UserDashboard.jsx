                        ...
                        <div className="p-6 border-b border-gray-100 flex-grow bg-gradient-to-br from-white to-gray-50">
                            ...
                            <div className="p-4 bg-gray-50 flex justify-between items-center shrink-0">
                                {booking.eventId && booking.status !== 'cancelled' ? (
                                    <>
                                        <Link to={`/event/${booking.eventId._id}`} className="bg-gray-900 hover:bg-black text-white px-4 py-2 rounded-lg text-sm font-semibold transition">View Event</Link>
                                        <button
